...
function promisify(name, middleware, parameters) {
	...
	var callback = function(err, data) {
		// console.log('~~~ FINISHED --- [[[ ' + name + ' vs ' + deferred.n);
		// console.log(arguments)
		if (err) {
			console.log('---- deferred ' + name + ' REJECTED!', err);
			deferred.reject(err);
		}	else {
			// console.log('++++ deferred ' + name + ' RESOLVED!', data);
			deferred.resolve(true);
		}
	};
	parameters.push(callback);
	// console.log('~~~ started --- [[[ ' + typeof middleware + ' as ' + name);
